...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView txtTodoname;

  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgDelete,
      @NonNull ImageView imgEdit, @NonNull TextView txtTodoname) {
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txt_todoname;
      TextView txtTodoname = ViewBindings.findChildViewById(rootView, id);
      if (txtTodoname == null) {
        break missingId;
      }

      return new ListItemBinding((ConstraintLayout) rootView, imgDelete, imgEdit, txtTodoname);
    }
